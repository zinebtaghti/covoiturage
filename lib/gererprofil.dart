    ...
    return MaterialApp(
      ...
      theme: ThemeData.dark().copyWith(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          contentPadding: EdgeInsets.symmetric(vertical: 16.0, horizontal: 16.0), // Reducing space before icons
        ),
      ),
...
class ProfileManagementScreen extends StatelessWidget {
    ...
    return Container(
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          ...
          minimumSize: Size(double.infinity, 50), // Ensures the button is wide and has a consistent height
  ...
  Widget _buildRoundedButton(BuildContext context, String text, Color backgroundColor, Color textColor) {
    return Container(
      width: double.infinity, // Ensures the button is wide
