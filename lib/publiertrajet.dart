...
// Créez une classe pour représenter un trajet de conducteur
class DriverTrip {
...
// Stockez les trajets des conducteurs dans une liste (simulons une liste statique ici)
  ...
  void matchTrips() {
    setState(() {
      ...
      for (var trip in driverTrips) {
        // Comparez les informations du passager avec celles des conducteurs
