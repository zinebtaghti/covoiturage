...
// Classe représentant un trajet de passager
class PassengerTrip {
  final String departureLocation;
  final String destination;
  final double price;
...
// Liste des trajets de passagers (simulons une liste statique ici)
List<PassengerTrip> passengerTrips = [
  PassengerTrip(departureLocation: 'Paris', destination: 'Lyon', price: 50.0, departureTime: DateTime(2024, 4, 1, 9, 0)),
  PassengerTrip(departureLocation: 'Lyon', destination: 'Marseille', price: 70.0, departureTime: DateTime(2024, 4, 1, 10, 0)),
  PassengerTrip(departureLocation: 'Paris', destination: 'Marseille', price: 80.0, departureTime: DateTime(2024, 4, 1, 8, 0)),
];
...
class _PublierState extends State<Publier> {
  ...
  void matchTrips() {
    setState(() {
      ...
      for (var trip in passengerTrips) { // Utilisez passengerTrips pour comparer avec les trajets des passagers
                              ...
                              actions: [
                                ElevatedButton(
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => TrajetConducteur()), // Naviguer vers l'écran TrajetPassager
                                    );
                                  },
                                  child: Text('Choisir'),
                                ),
